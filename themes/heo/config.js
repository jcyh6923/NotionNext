const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2026-07-05', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.coolc.de' },
    { title: '人生如戏 全靠演技', url: '' }
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '没事',
  HEO_HERO_TITLE_2: '瞎折腾',
  HEO_HERO_TITLE_3: 'blog.coolc.de',
  HEO_HERO_TITLE_4: '新版上线',
  HEO_HERO_TITLE_5: 'NotionNext4.0 轻松定制主题',
  HEO_HERO_TITLE_LINK: 'https://blog.coolc.de',
  // 英雄区遮罩文字
  ...
  HEO_INFO_CARD_URL3: 'https://blog.coolc.de',
